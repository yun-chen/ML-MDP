...
public class MyBasicBehavior {
	...
	static LearningAgentFactory qLearningFactory[] = new LearningAgentFactory[groupSize];
...
//
	...
	public void experimentAndPlotter(int k){
		...
		((FactoredModel)domain[k].getModel()).setRf(new GoalBasedRF(this.goalCondition, 5.0, -0.1));

		/**
		 * Create factories for Q-learning agent and SARSA agent to compare
		 */
		qLearningFactory[k] = new LearningAgentFactory() {
			...
			public LearningAgent generateAgent() {
				return new QLearning(domain[k], 0.99, hashingFactory, 0.3, 0.1);
			}
		};

		LearningAgentFactory valueIterationFactory = new LearningAgentFactory() {
	...
	LearningAlgorithmExperimenter exp = new LearningAlgorithmExperimenter(env[k], 10, 100, 
			qLearningFactory[0], qLearningFactory[1]);//, sarsaLearningFactory);
	...
	public static void main(String[] args) {
		MyBasicBehavior example = new MyBasicBehavior();
